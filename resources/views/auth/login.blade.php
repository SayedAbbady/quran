...
<body class="form">
    ...
    <div class="form-container">
        <div class="form-form">
            <div class="form-form-wrap">
                <div class="form-container">
                    ...
                    <p class="terms-conditions">© 2020 All Rights Reserved. <a href="{{route('home')}}">Quran talent</a> institute 
        ...
        <div class="form-image">
            <div class="l-image text-center" style="background-image:none">
            <img src="{{asset('/assets/img/bkwhite.png')}}" width="50%" style="margin-top: 70px" alt="">
            </div>
        </div>
    </div>
